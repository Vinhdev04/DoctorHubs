...
<body>
    ...
    <div class="container p-4">
        <div class="d-flex align-items-center mb-4">
            ...
            <span class="ml-2"
                style="margin-top: 0;margin-bottom: 0; font-weight: 500;line-height: 1.2; font-size: 20px;margin-left: 10px;">Khám
                Chuyên khoa</span>
        </div>
        ...
        <div class="row">
            <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-4">
                <div class="card h-100 text-center">
                    <img alt="Illustration of a knee joint" class="card-img-top lazyload"
                        data-src="../../assets/images/Icon/co-xuong-khop.png" />
                    <a href="./CoXuongKhop.php" class="card-body" style="text-decoration: none;">
            ...
            <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-4">
                <div class="card h-100 text-center">
                    <img alt="Illustration of a brain" class="card-img-top lazyload"
                        data-src="../../assets/images/Icon/than-kinh.png" />
                    <a href="./ThanKinh.php" class="card-body" style="text-decoration: none;">
                        <h5 class="card-title">Thần Kinh</h5>
                    </a>
                </div>
            </div>
            ...
            <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-4">
                <div class="card h-100 text-center">
                    <img alt="Illustration of a stomach" class="card-img-top lazyload"
                        data-src="../../assets/images/Icon/tieu-hoa.png" />
                    <a href="./TieuHoa.php" class="card-body" style="text-decoration: none;">
                        <h5 class="card-title">Tiêu hóa</h5>
                    </a>
                </div>
            </div>
            ...
            <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-4">
                <div class="card h-100 text-center">
                    <img alt="Illustration of a heart with a heartbeat line" class="card-img-top lazyload"
                        data-src="../../assets/images/Icon/tim-mach.png" />
                    <a href="./Timmach.php" class="card-body" style="text-decoration: none;">
            ...
            <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-4">
                <div class="card h-100 text-center">
                    <img alt="Illustration of acupuncture" class="card-img-top lazyload"
                        data-src="../../assets/images/Icon/san-phu-khoa.png" />
                    <div class="card-body">
            ...
            <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-4">
                <div class="card h-100 text-center">
                    <img alt="Illustration of acupuncture" class="card-img-top lazyload"
                        data-src="../../assets/images/Icon/sieu-am-thai.png" />
                    <div class="card-body">
                        <h5 class="card-title">Siêu Âm Thai</h5>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-4">
                <div class="card h-100 text-center">
                    <img alt="Illustration of acupuncture" class="card-img-top lazyload"
                        data-src="../../assets/images/Icon/nhi-khoa.png" />
                    <div class="card-body">
            ...
            <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-4">
                <div class="card h-100 text-center">
                    <img alt="Illustration of acupuncture" class="card-img-top lazyload"
                        data-src="../../assets/images/Icon/da-lieu.png" />
                    <div class="card-body">
            ...
            <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-4">
                <div class="card h-100 text-center">
                    <img alt="Illustration of acupuncture" class="card-img-top lazyload"
                        data-src="../../assets/images/Icon/viem-gan.png" />
                    <div class="card-body">
                        <h5 class="card-title">Bệnh viêm gan</h5>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-4">
                <div class="card h-100 text-center">
                    <img alt="Illustration of acupuncture" class="card-img-top lazyload"
                        data-src="../../assets/images/Icon/suc-khoe-tam-than.png" />
                    <div class="card-body">
                        <h5 class="card-title">Sức khỏe tâm thần</h5>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-4">
                <div class="card h-100 text-center">
                    <img alt="Illustration of acupuncture" class="card-img-top lazyload"
                        data-src="../../assets/images/Icon/di-ung-mien-dich.png" />
                    <div class="card-body">
                        <h5 class="card-title">Dị ứng miễn dịch</h5>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-4">
                <div class="card h-100 text-center">
                    <img alt="Illustration of acupuncture" class="card-img-top lazyload"
                        data-src="../../assets/images/Icon/ho-hap-phoi.png" />
                    <div class="card-body">
                        <h5 class="card-title">Hô hấp - Phổi</h5>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-4">
                <div class="card h-100 text-center">
                    <img alt="Illustration of acupuncture" class="card-img-top lazyload"
                        data-src="../../assets/images/Icon/ngoai-than-kinh.png" />
                    <div class="card-body">
                        <h5 class="card-title">Ngoại thần kinh</h5>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-4">
                <div class="card h-100 text-center">
                    <img alt="Illustration of acupuncture" class="card-img-top lazyload"
                        data-src="../../assets/images/Icon/nam-hoc.png" />
                    <div class="card-body">
                        <h5 class="card-title">Nam học</h5>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-4">
                <div class="card h-100 text-center">
                    <img alt="Illustration of acupuncture" class="card-img-top lazyload"
                        data-src="../../assets/images/Icon/mat.png" />
                    <div class="card-body">
                        <h5 class="card-title">Chuyên khoa mắt</h5>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-4">
                <div class="card h-100 text-center">
                    <img alt="Illustration of acupuncture" class="card-img-top lazyload"
                        data-src="../../assets/images/Icon/than-tiet-nieu.png" />
                    <div class="card-body">
                        <h5 class="card-title">Thận - Tiết niệu</h5>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-4">
                <div class="card h-100 text-center">
                    <img alt="Illustration of acupuncture" class="card-img-top lazyload"
                        data-src="../../assets/images/Icon/noi-khoa.png" />
                    <div class="card-body">
                        <h5 class="card-title">Nội khoa</h5>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-4">
                <div class="card h-100 text-center">
                    <img alt="Illustration of acupuncture" class="card-img-top lazyload"
                        data-src="../../assets/images/Icon/phuc-hoi-chuc-nang.png" />
                    <div class="card-body">
            ...
            <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-4">
                <div class="card h-100 text-center">
                    <img alt="Illustration of acupuncture" class="card-img-top lazyload"
                        data-src="../../assets/images/Icon/cong-huong-tu.png" />
                    <div class="card-body">
                        <h5 class="card-title">Chụp cộng hưởng từ</h5>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-4">
                <div class="card h-100 text-center">
                    <img alt="Illustration of acupuncture" class="card-img-top lazyload"
                        data-src="../../assets/images/Icon/chup-cat-lop.png" />
                    <div class="card-body">
                        <h5 class="card-title">Chụp cắt lớp vi tính</h5>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-4">
                <div class="card h-100 text-center">
                    <img alt="Illustration of acupuncture" class="card-img-top lazyload"
                        data-src="../../assets/images/Icon/ung-buou.png" />
                    <div class="card-body">
                        <h5 class="card-title">Ung Bướu</h5>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-4">
                <div class="card h-100 text-center">
                    <img alt="Illustration of acupuncture" class="card-img-top lazyload"
                        data-src="../../assets/images/Icon/da-lieu-tham-my.png" />
                    <div class="card-body">
                        <h5 class="card-title">Da liễu thẩm mỹ</h5>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-4">
                <div class="card h-100 text-center">
                    <img alt="Illustration of acupuncture" class="card-img-top lazyload"
                        data-src="../../assets/images/Icon/truyen-nhiem.png" />
                    <div class="card-body">
                        <h5 class="card-title">Truyền nhiễm</h5>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-4">
                <div class="card h-100 text-center">
                    <img alt="Illustration of acupuncture" class="card-img-top lazyload"
                        data-src="../../assets/images/Icon/bac-si-gia-dinh.png" />
                    <div class="card-body">
                        <h5 class="card-title">Bác sĩ gia đình</h5>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-4">
                <div class="card h-100 text-center">
                    <img alt="Illustration of acupuncture" class="card-img-top lazyload"
                        data-src="../../assets/images/Icon/tao-hinh-ham-mat.png" />
                    <div class="card-body">
                        <h5 class="card-title">Tạo hình mặt</h5>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-4">
                <div class="card h-100 text-center">
                    <img alt="Illustration of acupuncture" class="card-img-top lazyload"
                        data-src="../../assets/images/Icon/tu-van-tam-ly.png" />
                    <div class="card-body">
                        <h5 class="card-title">Tư vấn, trị liệu tâm lý</h5>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-4">
                <div class="card h-100 text-center">
                    <img alt="Illustration of acupuncture" class="card-img-top lazyload"
                        data-rc="../../assets/images/Icon/vo-sinh-hiem-muon.png" />
                    <div class="card-body">
                        <h5 class="card-title">Vô sinh - Hiếm muộn</h5>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-4">
                <div class="card h-100 text-center">
                    <img alt="Illustration of acupuncture" class="card-img-top lazyload"
                        data-src="../../assets/images/Icon/chan-thuong-chinh-hinh.png" />
                    <div class="card-body">
                        <h5 class="card-title">Chấn thương chỉnh hình</h5>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-4">
                <div class="card h-100 text-center">
                    <img alt="Illustration of acupuncture" class="card-img-top lazyload"
                        data-src="../../assets/images/Icon/nieng-rang.png" />
                    <div class="card-body">
            ...
            <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-4">
                <div class="card h-100 text-center">
                    <img alt="Illustration of acupuncture" class="card-img-top lazyload"
                        data-src="../../assets/images/Icon/boc-rang-su.png" />
                    <div class="card-body">
                        <h5 class="card-title">Bọc rắng sứ</h5>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-4">
                <div class="card h-100 text-center">
                    <img alt="Illustration of acupuncture" class="card-img-top lazyload"
                        data-src="../../assets/images/Icon/trong-rang.png" />
                    <div class="card-body">
                        <h5 class="card-title">Trồng rắng implant</h5>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-4">
                <div class="card h-100 text-center">
                    <img alt="Illustration of acupuncture" class="card-img-top lazyload"
                        data-src="../../assets/images/Icon/nho-rang-khon.png" />
                    <div class="card-body">
                        <h5 class="card-title">Nhổ răng khôn</h5>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-4">
                <div class="card h-100 text-center">
                    <img alt="Illustration of acupuncture" class="card-img-top lazyload"
                        data-src="../../assets/images/Icon/nha-khoa-tong-quat.png" />
                    <div class="card-body">
                        <h5 class="card-title">Nha khoa tổng quát</h5>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-4">
                <div class="card h-100 text-center">
                    <img alt="Illustration of acupuncture" class="card-img-top lazyload"
                        data-src="../../assets/images/Icon/nha-khoa-tre-em.png" />
                    <div class="card-body">
                        <h5 class="card-title">Nha khoa trẻ em</h5>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-4">
                <div class="card h-100 text-center">
                    <img alt="Illustration of acupuncture" class="card-img-top lazyload"
                        data-src="../../assets/images/Icon/tuyen-giap.png" />
                    <div class="card-body">
                        <h5 class="card-title">Tuyến giáp</h5>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-4">
                <div class="card h-100 text-center">
                    <img alt="Illustration of acupuncture" class="card-img-top lazyload"
                        data-src="../../assets/images/Icon/vu.png" />
                    <div class="card-body">
                        <h5 class="card-title">Chuyên Khoa vú</h5>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-4">
                <div class="card h-100 text-center">
                    <img alt="Illustration of acupuncture" class="card-img-top lazyload"
                        data-src="../../assets/images/Icon/ngoai-khoa.png" />
                    <div class="card-body">
                        <h5 class="card-title">Ngoại Khoa</h5>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-3 col-sm-6 mb-4">
                    ...
                    <div class="d-flex align-items-center">
                        <img src="img/icons/BCT.png" alt="Chứng nhận 1" class="me-2 lazyload" style="height: 30px" />
                        <img src="img/icons/DMCA.png" alt="Chứng nhận 2" style="height: 30px" class="lazyload" />
                    </div>
                    <h5 class="fw-bold mt-4 mb-3">HỖ TRỢ THANH TOÁN</h5>
                    <div class="d-flex flex-wrap">
                        <img src="/img/icons/COD-icons.png" alt="COD" class="me-2 mb-2 lazyload" style="height: 30px" />
                        <img src="/img/icons/VISA.png" alt="VISA" class="me-2 mb-2 lazyload" style="height: 30px" />
                        <img src="/img/icons/MasterCard.png" alt="Mastercard" class="me-2 mb-2 lazyload"
                            style="height: 30px" />
                        <img src="/img/icons/JCB.png" alt="JCB" class="me-2 mb-2 lazyload" style="height: 30px" />
                        <img src="/img/icons/Momo.png" alt="MoMo" class="me-2 mb-2 lazyload" style="height: 30px" />
                        <img src="/img/icons/ZaloPay.png" alt="ZaloPay" class="me-2 mb-2 lazyload"
                            style="height: 30px" />
                        <img src="img/icons/napas.png" alt="Napas" class="me-2 mb-2 lazyload" style="height: 30px" />
                        <img src="img/icons/apple-pay.png" alt="Apple Pay" class="me-2 mb-2 lazyload"
                            style="height: 30px" />
                    </div>
                </div>
            </div>
