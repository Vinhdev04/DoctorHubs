        ...
        <div class="container">
            <div class="row">
                <div
                    ...
                    <!-- Nút Call-to-Action -->
                    <a class="text-decoration-none btn cssbuttons-io-button" href="app/views/book.php">
                        Đặt Lịch Ngay
                        <div class="icon">
                ...
                <div class="col-md-7">
                    <a href="app/views/book.php" class="text-decoration-none banner__home--wrap mt-3 mt-md-0">
                        <img src="assets/images/Banner/BannerHome.png" alt="Banner Image"
                            class="img-fluid w-100 shadow rounded-2 mb-md-0 mb-3" />
                    </a>
                </div>
            </div>
        </div>
