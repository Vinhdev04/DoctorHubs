...
<body>
    ...
    <section class="py-4">
        <div class="container">
            <div class="row">
                <div class="col">
                    <div class="d-flex flex-column justify-content-between mb-4">
                        <h2 class="mb-0">Deal Đỉnh Rinh Ngay</h2>
                        <div class="d-flex align-items-center justify-content-between mt-3">
                            <div class="d-flex align-items-center w-50">
                                <span class="me-2">Sắp xếp theo:</span>
                                <button class="btn btn-primary me-2 btnDesc" id="filterDecrease">
                                    Giá giảm dần
                                </button>
                                <button class="btn btn-outline-secondary btnInsc" id="filterIncrease">
                                    Giá tăng dần
                                </button>
                            </div>
                            <div class="d-flex align-items-center w-50 justify-content-end">
                                <input type="text" class="form-control me-2 w-50 input"
            ...
            <div class="row">
                <div class="col-md-4 col-lg-3 col-sm-6" v-for="product in products" :key="product.id">
                    <div class="product-card position-relative">
                        ...
                        <p class="text-danger fw-bold">{{ product.price }} đ</p>
                        <button class="btn btn-primary">Chọn sản phẩm</button>
                    </div>
                </div>
            </div>
