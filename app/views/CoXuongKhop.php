...
<body>
    <div class="menu">
        <ul class="menu-content" style="padding-left: 0rem;">
            <li><a href="index.html"><span class="material-symbols-outlined">home</span><span
                        style="color: black;">Home</span></a></li>
            <li><a href="#"><span class="material-symbols-outlined">dashboard</span><span
                        style="color: black;">DashBoard</span></a></li>
            <li><a href="#"><span class="material-symbols-outlined">explore</span><span
                        style="color: black;">Explore</span></a></li>
            <li><a href="#"><span class="material-symbols-outlined">analytics</span><span
                        style="color: black;">Analytics</span></a></li>
            <li><a href="#"><span class="material-symbols-outlined">settings</span><span
                        style="color: black;">Settings</span></a></li>
            <li><a href="#"><span class="material-symbols-outlined">person</span><span
                        style="color: black;">Account</span></a></li>
            <li><a href="#"><span class="material-symbols-outlined">report</span><span
                        style="color: black;">Report</span></a></li>
            <li><a href="#"><span class="material-symbols-outlined">email</span><span
                        style="color: black;">Contact</span></a></li>
            <li><a href="#"><span class="material-symbols-outlined">logout</span><span
    ...
    <div class="container py-4 position-relative">
        ...
        <p class="mb-4">Danh sách các bác sĩ uy tín đầu ngành Cơ Xương Khớp tại Việt Nam:</p>
        <ul class="list-unstyled mb-4">
            <li class="mb-2">Các chuyên gia có quá trình đào tạo bài bản, nhiều kinh nghiệm</li>
            <li class="mb-2">Các giáo sư, phó giáo sư đang trực tiếp nghiên cứu và giảng dạy tại Đại học Y khoa Hà Nội
            </li>
            <li class="mb-2">Các bác sĩ đã, đang công tác tại các bệnh viện hàng đầu Khoa Cơ Xương Khớp - Bệnh viện Bạch
                Mai, Bệnh viện Hữu nghị Việt Đức, Bệnh Viện E.</li>
        </ul>
        ...
        <div class="d-flex justify-content-between align-items-center mb-4" style="margin-top: 20px;">
            <div class="dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                    ...
                    <a class="dropdown-item" href="#">TH HCM</a>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white shadow rounded-lg mt-4 p-4">
            <div class="d-flex flex-column flex-md-row">
                <div class="d-flex flex-1 align-items-start mb-4 mb-md-0">
                    <img alt="Doctor's image" class="rounded-circle mr-4" height="100"
                        src="../../assets/images/Doctors/avatar-TS.BS_.Chu-Trong-Hiep.webp" width="100" />
                    <div class="flex-1" style="margin-left: 10px;">
                        <div class="d-flex align-items-center mb-2">
                            <h3 class="h6 font-weight-bold">PGS. BSCKI. Tô Gia Bảo</h3>
                        </div>
                        <p class="text-muted mb-2">Bác sĩ có 35 năm kinh nghiệm về vực Cột sống,</p>
                        <p class="text-muted mb-2">thần kinh, cơ xương khớp</p>
                        <p class="text-muted mb-2">Phó chủ tịch hội Phẫu thuật cột sống Việt Nam</p>
                        <p class="text-muted mb-2">Bác sĩ nhận khám từ 7 tuổi trở lên</p>
                ...
                <div class="flex-1 mt-4 mt-md-0 ml-md-4" style="margin-left: 10px;">
                    ...
                    <div class="d-flex flex-wrap mb-4">
                        <button class="btn btn-secondary mb-2" style="height: 40px; width: 126.06px;">07:30 -
                            08:00</button>
                        <button class="btn btn-secondary mb-2" style="height: 40px; width: 126.06px;">08:30 -
                            09:00</button>
                        <button class="btn btn-secondary mb-2" style="height: 40px; width: 126.06px;">09:30 -
                            10:00</button>
                        <button class="btn btn-secondary mb-2" style="height: 40px; width: 126.06px;">10:30 -
                            11:00</button>
                        <button class="btn btn-secondary mb-2" style="height: 40px; width: 126.06px;">13:30 -
                            14:00</button>
                        <button class="btn btn-secondary mb-2" style="height: 40px; width: 126.06px;">14:30 -
                            15:00</button>
                        <button class="btn btn-secondary mb-2" style="height: 40px; width: 126.06px;">15:00 -
                            15:30</button>
                        <button class="btn btn-secondary mb-2" style="height: 40px; width: 126.06px;">15:30 -
                            16:00</button>
                    </div>
                    ...
                    <div class="text-muted">
                        <h4 class="text-primary font-weight-semibold" id="priceHeading1">GIÁ KHÁM: 500.000đ</h4>
                        <a class="text-primary" href="#" id="viewPriceDetails1">Xem chi tiết</a>
        ...
        <div class="bg-white shadow rounded-lg mt-4 p-4">
            <div class="d-flex flex-column flex-md-row">
                <div class="d-flex flex-1 align-items-start mb-4 mb-md-0">
                    <img alt="Doctor's image" class="rounded-circle mr-4 lazyload" height="100"
                        data-src="../../assets/images/Doctors/avatar-truong-trong-tuan.png" width="100" />
                    <div class="flex-1" style="margin-left: 10px;">
                        <div class="d-flex align-items-center mb-2">
                            <h3 class="h6 font-weight-bold">ThS.BS Nguyễn Trần Trung</h3>
                        </div>
                ...
                <div class="flex-1 mt-4 mt-md-0 ml-md-4" style="margin-left: 10px;">
                    ...
                    <div class="text-muted">
                        <h4 class="text-primary font-weight-semibold" id="priceHeading2">GIÁ KHÁM: 500.000đ</h4>
                        <a class="text-primary" href="#" id="viewPriceDetails2">Xem chi tiết</a>
                    ...
                    <div class="text-muted mb-2">
                        <h4 class="text-primary font-weight-semibold" id="priceHeading3">LOẠI BẢO HIỂM ÁP DỤNG</h4>
                        <a class="text-primary" href="#" id="viewPriceDetails3">Xem chi tiết</a>
                            ...
                            <table>
                                ...
                                <tr>
                                    <td class="service-name" colspan="2">
                                        ...
                                        <p class="note">Phòng khám chưa áp dụng bảo hiểm bảo lãnh. Phòng khám có xuất
                                            hóa đơn điện tử (tùy thuộc từng loại bảo hiểm áp dụng)</p>
                                    </td>
                                </tr>
                            </table>
                        </div>
        ...
        <div class="bg-white shadow rounded-lg mt-4 p-4">
            <div class="d-flex flex-column flex-md-row">
                <div class="d-flex flex-1 align-items-start mb-4 mb-md-0">
                    <img alt="Doctor's image" class="lazyload rounded-circle mr-4 lazyload" height="100"
                        data-src="../../assets/images/Doctors/1536566238-bacsy.jpg" width="100" />
                    <div class="flex-1" style="margin-left: 10px;">
                        <div class="d-flex align-items-center mb-2">
                ...
                <div class="flex-1 mt-4 mt-md-0 ml-md-4" style="margin-left: 10px;">
                    ...
                    <div class="text-muted">
                        <h4 class="text-primary font-weight-semibold" id="priceHeading4">GIÁ KHÁM: 500.000đ</h4>
                        <a class="text-primary" href="#" id="viewPriceDetails4">Xem chi tiết</a>
                    ...
                    <div class="text-muted mb-2">
                        <h4 class="text-primary font-weight-semibold" id="priceHeading5">LOẠI BẢO HIỂM ÁP DỤNG</h4>
                        <a class="text-primary" href="#" id="viewPriceDetails5">Xem chi tiết</a>
        ...
        <div class="bg-white shadow rounded-lg mt-4 p-4">
            <div class="d-flex flex-column flex-md-row">
                <div class="d-flex flex-1 align-items-start mb-4 mb-md-0">
                    <img alt="Doctor's image" class="lazyload rounded-circle mr-4" height="100"
                ...
                <div class="flex-1 mt-4 mt-md-0 ml-md-4" style="margin-left: 10px;">
                    ...
                    <div class="text-muted mb-2">
                        <h4 class="text-primary font-weight-semibold" id="priceHeading6">GIÁ KHÁM: 300.000đ - 400.000đ
                        </h4>
                        <a class="text-primary" href="#" id="viewPriceDetails6">Xem chi tiết</a>
        ...
        <div class="bg-white shadow rounded-lg mt-4 p-4">
            <div class="d-flex flex-column flex-md-row">
                <div class="d-flex flex-1 align-items-start mb-4 mb-md-0">
                    <img alt="Doctor's image" class="lazyload rounded-circle mr-4" height="100"
                        data-src="../../assets/images/Doctors/045850-bac-si-da-lieu-hoai-thu.jpg" width="100" />
                    <div class="flex-1" style="margin-left: 10px;">
                        <div class="d-flex align-items-center mb-2">
                            <h3 class="h6 font-weight-bold">Tiến sĩ, Bác sĩ chuyên khoa II Lê Quốc Việt</h3>
                        </div>
                        <p class="text-muted mb-2">Hơn 30 năm kinh nghiệm khám và điều trị các bệnh nội cơ xương khớp và
                        </p>
                ...
                <div class="flex-1 mt-4 mt-md-0 ml-md-4" style="margin-left: 10px;">
                    ...
                    <div class="text-muted mb-2">
                        <h4 class="text-primary font-weight-semibold" id="promotionHeading">CHƯƠNG TRÌNH KHUYẾN MẠI
                        </h4>
                        <a class="text-primary" href="#" id="viewPromotionDetails">Xem chi tiết</a>
                    </div>
                    <!-- Dialog modal -->
                    <div id="promotionDialog" class="promotion-dialog">
                        <div class="promotion-dialog-content">
                            <span class="close-dialog">&times;</span>
                            <h4>Tổ hợp Y tế Mediplus</h4>
                            <div class="promotion-details">
                                <p><strong>Thông 4 yêu thương - Chăm sóc sức khỏe vàng</strong></p>
                                <ul>
                                    <li><strong>Giảm 40%</strong> phí khám Sản phụ khoa, kiểm muyễn với BS Nguyễn Tiến
                                        Đại</li>
                                    <li><strong>Giảm 30%</strong> chụp MRI sọ não, cột sống cổ, cột sống thắt lưng</li>
                                    <li><strong>Giảm 10%</strong> dịch vụ chụp CT, MRI khác</li>
                                    <li><strong>Giảm 20%</strong> gói tầm soát sức khỏe vượt trội bằng công nghệ hiện
                                        đại <em>(Khi khu VIP)</em></li>
                                    <li><strong>Giảm 20%</strong> gói tổng quát Nam/Nữ cơ bản hoặc nâng cao</li>
                                    <li><strong>Tặng miễn phí</strong> các HP da dày cho khách hàng Nội soi dạ dày/ tá
                                        tràng-đại tràng</li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="text-muted mb-2">
                        <h4 class="text-primary font-weight-semibold" id="priceHeading7">GIÁ KHÁM: 350.000đ</h4>
                        <a class="text-primary" href="#" id="viewPriceDetails7">Xem chi tiết</a>
    ...
    <footer class="bg-light pt-5 pb-3 border-top">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-3 col-sm-6 mb-4">
                    ...
                    <div class="d-flex align-items-center">
                        <img data-src="../../assets/images/Icon/BCT.png" alt="Chứng nhận 1" class="me-2 lazyload"
                            style="height: 30px" />
                        <img data-src="../../assets/images/Icon/DMCA.png" alt="Chứng nhận 2" style="height: 30px"
                            class="lazyload" />
                    </div>
                    ...
                    <div class="d-flex flex-wrap">
                        ...
                        <img data-src="/../../assets/images/Icon/20240706162729-0-ZaloPay.png" alt="ZaloPay"
                            class="me-2 mb-2 lazyload" style="height: 30px" />
                        <img data-src="../../assets/images/Icon/napas.png" alt="Napas" class="me-2 mb-2 lazyload"
                            style="height: 30px" />
                        <img data-src="../../assets/images/Icon/apple-pay.png" alt="Apple Pay"
                            class="me-2 mb-2 lazyload" style="height: 30px" />
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 d-flex align-items-center justify-content-center">
                ...
                <a href="https://www.instagram.com/baoldz3009/" class="fw-semibold text-decoration-none"
                    style="color: var(--primary-color); margin-left: 5px;">OniiChan-Baka</a>
            </div>
        </div>
    </footer>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Xử lý cho phần xem chi tiết giá khám (nếu cần)
