            ...
            <div class="row">
                ...
                <div class="col-md-3 col-sm-6 mb-4">
                    ...
                    <ul class="list-unstyled text-muted">
                        ...
                        <li><a href="#" class="text-decoration-none text-secondary">Quy trình giải quyết tranh chấp</a>
                        </li>
                        <li><a href="#" class="text-decoration-none text-secondary">Chính sách bảo mật thông tin</a>
                        </li>
                    </ul>
                </div>
                ...
                <div class="col-md-3 col-sm-6 mb-4">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <img data-src="./assets/images/Icon/20240706162441-0-DMCA.png" alt="Chứng nhận 2"
                            class="lazyload" style="height: 30px" />
                    </div>
                    ...
                    <div class="d-flex flex-wrap">
                        ...
                        <img data-src="./assets/images/Icon/20241122062454-0-napas.png" alt="Napas"
                            class="me-2 mb-2 lazyload" style="height: 30px" />
                        <img data-src="./assets/images/Icon/20241122063240-0-apple-pay.png" alt="Apple Pay"
                            class="me-2 mb-2 lazyload" style="height: 30px" />
                    </div>
                </div>
            </div>
